...
export default function RightSidebar({
  ...
  return (
    <aside className="fixed right-0 top-0 z-50 hidden h-screen w-[410px] justify-center px-5 py-4 lg:flex">
      <div className="flex h-[calc(100vh-32px)] w-full flex-col overflow-hidden rounded-[26px] border border-white/80 bg-white shadow-[0_18px_55px_rgba(15,23,42,0.16)] dark:border-slate-700 dark:bg-slate-900 dark:shadow-[0_18px_55px_rgba(0,0,0,0.35)]">
